...
public class PrintStreamWithMethod {
    ...
    public static void main(String[] args) {
       ...
       // try (PrintStream ps = new PrintStream("C:/Users/Stergios/file7-ps.txt",StandardCharsets.UTF_8)){
        try (PrintStream ps = new PrintStream(new FileOutputStream("C:/Users/Stergios/file7-ps.txt", true),
                true, StandardCharsets.UTF_8)){
            printMessage(ps, "Hello Coding Factory!");
            printMessage(ps, "example1");
